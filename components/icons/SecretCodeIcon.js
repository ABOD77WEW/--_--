...
const SecretCodeIcon = (props) => (
  React.createElement(
    ...
    React.createElement('circle', { cx: "11.5", cy: "16", r: "1.5", fill: "currentColor" }),
    React.createElement('path', { d: "M11.5 17.5V19", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round" })
  )
);
