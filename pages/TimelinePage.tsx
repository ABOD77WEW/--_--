...
const TimelineDetails: React.FC<{ arc: Arc }> = ({ arc }) => {
    ...
    return (
        <div className="w-full text-center p-4">
            <button onClick={(e) => { e.stopPropagation(); toggleFavorite(arc, 'arcs'); }} className="absolute top-6 left-6 z-10 p-3 rounded-full bg-black/30 hover:bg-yellow-500/50 transition-colors duration-300 backdrop-blur-sm" aria-label="إضافة للمفضلة">
