...
import MangekyoProIcon from '../components/icons/MangekyoProIcon.js';
...
const ProPage = () => {
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(MangekyoProIcon, { className: "w-28 h-28 text-purple-400", style: { filter: 'drop-shadow(0 0 20px #a855f7)' } })
    ),
    React.createElement(
      'h1',
      { className: "font-cairo text-5xl md:text-6xl font-black text-transparent bg-clip-text bg-gradient-to-br from-purple-400 to-red-500 mb-4" },
